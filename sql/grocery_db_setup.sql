...
insert into trips (store_id, date, total_cost)
values (4,'2024-03-08',19.93), 
(2,'2024-03-08',59.71);


insert into items (trip_id, product_name, quantity_unit, quantity, price_per_unit, total_price, sku, weight_oz)
VALUES
(58, 'CHEEZ-ITS', 'PC',1, 2.98,2.98,2410078938,NULL),
(58, 'POLAR SELTZER 8 PK','PC',1,3.28,3.28,7153700366,96),
(58, 'LIQUID DEATH', 'PC',4,1.28,5.12,85003170018,76),
(58, 'EMBASA SALSA VERDE','PC',1,1.00,1.00,7538604987,7),
(58, 'FIT CRUNCH PROTEIN BAR', 'PC',2,1.98,3.96,81771902158,NULL),
(58, 'WINCO BUTTER', 'PC',1,3.68,3.68,7055240402,16),
(58, 'WHITE ONION','LBS',.82,1.68,1.38,4663,12),
(58, 'GREEN ONION', 'PC',1,.78,.78,4068,NULL),
(58, 'ZUCCHINI','LBS',.73,.98,.72,4067,11),
(58, 'WINCO DELI SANDWICH', 'PC',1,2.98,2.98,26731000000,NULL),
(58, 'CILANTRO', 'PC',1,.68,.68,4889,NULL),
(58, 'MOZZARELLA BULK CHEESE', 'PC',1,3.56,3.56,21718800000,NULL),
(58, 'OAT MILK EXTRA CREAMY HALF GAL', 'PC',1,2.98,2.98,4410015619,52),
(58, 'RED ONION', 'LBS',.68,1.19,.81,4082,11),
(58, 'LEMON SMALL', 'PC',1,.38,.38,4985,NULL),
(58, 'WINCO SOUR CREAM', 'PC',1,1.18,1.18,7055240213,8),
(58, 'ORG AVOCADO 3 EA', 'PC',1,4.48,4.48,61942200018,NULL),
(58, 'ORG CHIVES', 'PC',1,1.98,1.98,76857300243,NULL),
(58, 'CAULIFLOWER', 'LBS',2.05,1.28,2.62,4079,32),
(58, 'POTATOES YELLOW 5 LBS', 'PC',1,3.48,3.48,69477062331,80),
(58, 'BELL RED PEPPER', 'PC',1,1.28,1.28,4688,NULL),
(58, 'CARROTS 5 LBS BAG', 'PC',1,3.48,3.48,3338366403,80),
(58, 'LA BURRITA TORTILLAS', 'PC',1,5.54,5.54,3723299992,NULL);

SELECT SUM(TOTAL_PRICE) FROM ITEMS WHERE TRIP_ID = 58;

insert into items (trip_id, product_name, quantity_unit, quantity, price_per_unit, total_price, sku, weight_oz)
VALUES
(57, 'STRABWERRY PRESERVES', 'PC',1,3.99,3.99,NULL,17.5),
(57, 'ROASTED GARLIC MARINARA', 'PC',1,1.99,1.99,NULL,24),
(57, 'PASTA RAVIOLI CHEESE', 'PC',1,2.99,2.99,NULL,10),
(57, 'ORGANIC HOT COCOA MIX', 'PC',1,3.99,3.99,NULL,10),
(57, 'ORGANIC PEPPERMINT TEA', 'PC',1,2.99,2.99,NULL,1),
(57, 'ORG GINGER TURMERIC TEA', 'PC',1,2.99,2.99,NULL,1),
(57, 'PASTA LINGUINE', 'PC',1,.99,.99,NULL,16);
